 ...
 */
public class Process implements Constants, Comparable<Process>
{
    ...
    public void leftMemoryQueue(long clock) {
    	...
    	System.out.println("Left memory queue");
		  timeSpentWaitingForMemory += clock - timeOfLastEvent;
		  timeOfLastEvent = clock;
		  timeToNextIoOperation = (long)20 + (long)(Math.random()*2*avgIoInterval);
    }
    
    /**
     * This method is called when the process leaves the cpu/ready queue (and
     * enters the cpu).
     * 
     * @param clock The time when the process leaves the ready queue.
     */
    
    public void leftReadyQueue(long clock) {
    	System.out.println(processId);
    	System.out.println("Left ready queue");
    ...
    /**
     * This method is called when the process leaves the cpu (and is either done
     * or enters the IO queue).
     * 
    ...
    /**
     * This method is called when the process leaves the I/O queue (and enters I/O).
     * 
     * @param clock The time when the process leaves the I/O queue.
     */
    
    public void leftIoQueue(long clock) {
    	System.out.println(processId);
    	System.out.println("Left io queue");
    ...
    /**
     *  This method is called when the process leaves I/O (and enters CPU queue).
     * 
     * @param clock The time when the process leaves the I/O.
     */
    
    public void leftIO(long clock) {
    	System.out.println(processId);
    	System.out.println("Left io");
	...
	/**
	 * Returns the amount of cpu time still needed by this process.
	 * 
	 * @return the amount of cpu time needed by this process.
	 */
	...
	/**
	 * Returns the amount of time til the next time this process needs an I/O operation.
	 * 
	 * @return the amount of time til next I/O operation.
	 */
	...
	public void updateStatistics(Statistics statistics) {
		...
		statistics.totalNofTimesPlacedInIoQueue += nofTimesInIoQueue;
		statistics.totalNofTimesPlacedInReadyQueue += nofTimesInReadyQueue;
		statistics.nofCompletedProcesses++;
	}

	@Override
	public int compareTo(Process p) {
		return (int)(cpuTimeNeeded-p.cpuTimeNeeded);
	}
